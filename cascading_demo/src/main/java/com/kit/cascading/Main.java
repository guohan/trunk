...
public static void main( String[] args )
    ...
    String inputPath = "D://git//cascading_demo//target//cascading_demo-0.0.1-SNAPSHOT.jar";
    String pagesPath ="D://gzkiterp//workspace//cascading_demo//data//data//url+page.200.txt" + "/pages/";
    String urlsPath ="D://gzkiterp//workspace//cascading_demo//data//data//url+page.200.txt" + "/urls/";
    String wordsPath ="D://cascading//output"+ "/words/";
    String localUrlsPath ="D://cascading//local" + "/urls/";
    String localWordsPath = "D://cascading//local" + "/words/";
